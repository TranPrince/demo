...
public class UrlUtilTest extends TestCase {
    ...
    public void testQuerySimple() throws UnsupportedEncodingException {
        ...
        assertEquals("%D6%D0%B9%FA", UrlUtil.encodeQueryParam("中国", Constants.GBK));
        ...
        assertEquals("中国", UrlUtil.decode("%e4%b8%ad%e5%9b%bd"));
        assertEquals("中国", UrlUtil.decode("%D6%D0%B9%FA", Constants.GBK));
        assertEquals("中国", UrlUtil.decodeQuery("%D6%D0%B9%FA", Constants.GBK));
    }
    ...
    public void testQueryParam() {
        ...
        System.out.println(UrlUtil.decodeQuery(http_request, Constants.GBK));
    }

...
public class WebUtilTest extends TestCase {
    ...
    public void testescapeEncoding() throws UnsupportedEncodingException {
        ...
        //GBK
        assertEquals(gbk, WebUtil.escape(unescape, Constants.GBK));
        assertEquals(unescape, WebUtil.unescape(gbk, Constants.GBK));

        //utf8
        assertEquals(utf8, WebUtil.escape(unescape, Constants.UTF_8));
        assertEquals(unescape, WebUtil.unescape(utf8, Constants.UTF_8));
    }

...
public class ConvertUtilTest {
    ...
    public void testencodeBytes() throws UnsupportedEncodingException {
        String str = "中文";
        System.out.println(new String(ConvertUtil.encodeBytes(str.getBytes(Constants.GBK), ' ')));
        System.out.println(new String(ConvertUtil.encodeBytes(str.getBytes(Constants.UTF_8), ' ')));
    }

    @Test
    public void testBytesToHexString() throws UnsupportedEncodingException {
        String str = "中文";
        byte[] uft8_bytes = str.getBytes(Constants.UTF_8);
        ...
        byte[] gbk_bytes = str.getBytes(Constants.GBK);
        String gbk_hexStr = ConvertUtil.bytesToHexString(str.getBytes(Constants.GBK));
        ...
        //用户GBK数字新建字符串
        System.out.println(new String(gbk_bytes, Constants.GBK));

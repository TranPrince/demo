...
public class FileUtilTest {
    ...
    public void testLines() {
        ...
        utf8lines = FileUtil.lines(new File(utf8file), Constants.UTF_8);
        System.out.println(utf8lines);
        System.out.println("读取文件的前3行");
        lines = FileUtil.lines(new File(utf8file), 3, Constants.UTF_8);
        System.out.println(lines);
    ...
    public void testAppendLine() {
        ...
        FileUtil.appendLine(efile, line1, Constants.UTF_8);
        FileUtil.appendLine(efile, line2, Constants.UTF_8);
        ...
        FileUtil.appendLine(utf8file, line1, Constants.UTF_8);
        FileUtil.appendLine(utf8file, line2, Constants.UTF_8);
    ...
    public void testWriteFile() {
        ...
        FileUtil.write(new File(path + "efile1_UTF8.TXT"), etemp, Constants.UTF_8);
        FileUtil.write(new File(path + "efile2_UTF8.TXT"), etemp, Constants.UTF_8);
        FileUtil.writeAppend(new File(path + "efile2_UTF8.TXT"), etemp, Constants.UTF_8);
        FileUtil.write(new File(path + "cfile1_UTF8.TXT"), ctemp, Constants.UTF_8);
        FileUtil.write(new File(path + "cfile2_UTF8.TXT"), ctemp, Constants.UTF_8);
        FileUtil.writeAppend(new File(path + "cfile2_UTF8.TXT"), ctemp, Constants.UTF_8);
    }
}
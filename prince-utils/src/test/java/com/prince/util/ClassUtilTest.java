...
import com.prince.temp.model.BusinessLog;
...
public class ClassUtilTest {
    ...
    public void testField() throws InvocationTargetException, IllegalAccessException {
        ...
        String[] fields = ClassUtil.getField("com.prince.temp.model.BusinessLog", true);
        for (String f : fields) {
    ...
    public void testPublicField() {
        ...
        String[] fields = ClassUtil.getPublicField("com.prince.temp.model.BusinessLog", true);
        for (String f : fields) {
            System.out.println(f);
        }
        System.out.println("=============获取类中的自定义public属性包括继承的==========");
        String[] fieldz = ClassUtil.getPublicField("com.prince.temp.model.BusinessLog", false);
        for (String f : fieldz) {
            System.out.println(f);
        }
    }
    ...
    public void testProtectedField() {
        ...
        String[] field = ClassUtil.getProtectedField("com.prince.temp.model.BusinessLog");
        for (String f : field) {
            System.out.println(f);
        }
    }
    ...
    public void testPrivateField() {
        ...
        String[] field = ClassUtil.getPrivateField("com.prince.temp.model.BusinessLog");
        for (String f : field) {
            System.out.println(f);
        }
    }
    ...
    public void testPrivateMetod() {
        ...
        String[] methods = ClassUtil.getPrivateMethod("com.prince.util.bean.BeanUtil");
    ...
    public void testProtectedMetod() {
        ...
        String[] methods = ClassUtil.getProtectedMethod("com.prince.util.bean.BeanUtil", false);
        for (String m : methods) {
            System.out.println(m);
        }
        System.out.println("=============获取自定义的和继承的Protected类型的方法==========");
        methods = ClassUtil.getProtectedMethod("com.prince.util.bean.BeanUtil", true);
        for (String m : methods) {
            System.out.println(m);
        }
    }
    ...
    public void testPublicMetod() {
        ...
        String[] methods = ClassUtil.getPublicMethod("com.prince.util.bean.BeanUtil", false);
        for (String m : methods) {
            System.out.println(m);
        }
        System.out.println("=============获取自定义的和继承的public类型的方法==========");
        methods = ClassUtil.getPublicMethod("com.prince.util.bean.BeanUtil", true);
        for (String m : methods) {
            System.out.println(m);
        }
    }
    ...
    public void testMetod() throws InvocationTargetException, IllegalAccessException {
        ...
        String[] methods = ClassUtil.getMethod("com.prince.util.StringUtil", false);
        for (String m : methods) {
            System.out.println(m);
        }
        System.out.println("=========自定义的方法和继承来的方法===========");
        methods = ClassUtil.getMethod("com.prince.util.StringUtil", true);
        for (String m : methods) {
            System.out.println(m);
        }
...
//    }
    ...
    public void testGetSuperClass() {
        System.out.println(ClassUtil.getSuperClass("com.prince.temp.model.BusinessLog"));
        System.out.println(ClassUtil.getSuperClass("com.prince.temp.model.Log"));
    }

    @Test
    public void testGetSuperClassChian() {
        String[] superClassChian = ClassUtil.getSuperClassChian("com.prince.temp.model.BusinessLog");
        System.out.println(Arrays.toString(superClassChian));
        System.out.println(Arrays.toString(ClassUtil.getSuperClassChian("com.prince.temp.model.Log")));
    }
    ...
    public void testGetInterfaces() {
        ...
        interfaces = ClassUtil.getInterfaces("com.prince.temp.model.BusinessLog", false);
        System.out.println(Arrays.toString(interfaces));

        interfaces = ClassUtil.getInterfaces("com.prince.temp.model.BusinessLog", true);
        System.out.println(Arrays.toString(interfaces));
    }

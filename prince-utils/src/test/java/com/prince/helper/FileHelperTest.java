package com.prince.helper;

import com.prince.Constants;
import com.prince.functions.ObjectFilter;
import com.prince.functions.ObjectHandler;
import com.prince.functions.ObjectProcess;
import com.prince.util.TestUtil;
import com.prince.util.algorithmImpl.FileImpl;
...
public class FileHelperTest {
    ...
    public void handlerWithLine() {
        FileHelper.handlerWithLine(new File(file), Constants.UTF_8, new ObjectHandler<String>() {
            @Override
    ...
    public void processWithLine() {
        ...
        FileHelper.processWithLine(new File(file), Constants.UTF_8, lines, new ObjectProcess<String, String>() {
            @Override

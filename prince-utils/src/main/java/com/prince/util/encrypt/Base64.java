package com.prince.util.encrypt;
...
public final class Base64 {
    ...
    public final static byte[] encodeToByte(String s) {
        try {
            return encodeToByte(s.getBytes(Constants.UTF_8), false);
    ...
    public final static byte[] encodeToByte(String s, boolean lineSep) {
        try {
            return encodeToByte(s.getBytes(Constants.UTF_8), lineSep);
        } catch (UnsupportedEncodingException ignore) {
            return new byte[]{};
        }
    }
    ...
    public final static String decodeToString(byte[] arr) {
        try {
            return new String(decode(arr), Constants.UTF_8);
        } catch (UnsupportedEncodingException ignore) {
            return null;
        }
    }
    ...
    public final static String encodeToString(String s) {
        try {
            return new String(encodeToChar(s.getBytes(Constants.UTF_8), false));
        } catch (UnsupportedEncodingException ignore) {
            return null;
        }
    }
    ...
    public final static String encodeToString(String s, boolean lineSep) {
        try {
            return new String(encodeToChar(s.getBytes(Constants.UTF_8), lineSep));
        } catch (UnsupportedEncodingException ignore) {
            return null;
        }
    }
    ...
    public final static String decodeToString(String s) {
        try {
            return new String(decode(s), Constants.UTF_8);
        } catch (UnsupportedEncodingException ignore) {
            return null;
        }
    }

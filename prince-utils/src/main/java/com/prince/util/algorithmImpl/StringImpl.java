...
import com.prince.util.SysUtil;
...
public class StringImpl {
    ...
    public static String simpleEncoding(String str) {
        try {
            ...
            if (str.equals(new String(bs, Constants.UTF_8))) {
                return Constants.UTF_8;
            }
            if (str.equals(new String(bs, Constants.GBK))) {
                return Constants.GBK;
            }
            if (str.equals(new String(bs, Constants.ISO_8859_1))) {
